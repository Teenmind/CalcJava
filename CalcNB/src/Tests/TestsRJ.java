...
public class TestsRJ 
{
	...
	{	
    	calc.textBox("fx").enterText(numberA);
    	calc.textBox("fy").enterText(numberB);
    	calc.textBox("fop").enterText(op);
		calc.button("calc").click();
		assertEquals(expected, calc.textBox("fres").text());
	}          
}
